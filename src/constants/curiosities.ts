    ...
    options: [
      {
        id: 1,
        answer:
          "Você sabia que nem todos os planetas do Sistema Solar são sólidos? Na verdade, esse tipo de planeta (sólido), chamado de planeta telúrico, representa metade dos planetas do Sistema Solar. Apenas Mercúrio, Vênus, Terra e Marte são rochosos. Os gigantes gasosos, como Júpiter, Saturno, Urano e Netuno, são compostos majoritariamente por gases de hidrogênio, hélio e metano e são geralmente muito frios, de massas gigantescas. Júpiter, por exemplo, tem volume de 1.321 “Terras” e massa 317 vezes maior que a do nosso planeta. Além disso, sua massa é cerca de 2,5 vezes maior que a massa de todos os demais planetas do Sistema Solar juntos.",
      },
    ],
  },
  {
